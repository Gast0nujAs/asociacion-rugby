  ...
  return (
    <section>
      <picture>
        ...
        <img src={image1} alt="image article" className='w-[320px] h-[160px] sm:w-[640px] sm:h-[500px] lg:w-[3200px] lg:h-[600px]' />
      </picture>
      <div className='sm:flex'>
        ...
        <div className='flex-1 py-2 sm:pt-5 sm:mb-5'>
          <p className='text-[11px] mb-2 sm:mb-10 sm:text-[18px]'>El rugby, un deporte donde la diversidad es su esencia, abre sus puertas a todos los niños y jóvenes, sin distinción de género. 
